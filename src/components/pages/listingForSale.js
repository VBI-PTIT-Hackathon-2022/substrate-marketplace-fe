...
`;
function ListingForSale(Component) {
                        ...
                        <div className='container'>
                            <div className='row m-10-hor'>
                                <div className='col-12'>
                                    <h1 className='text-center' style={{color: "black"}}>Listing NFT for Sale</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="field-set">
                                    ...
                                    <div className="de_tab tab_methods">
                                        ...
                                        <div className="de_tab_content pt-3">
                                            ...
                                            <div id="tab_opt_2" >
                                                <h5>Price listing</h5>
                                                <input type="text" name="fee" id="item_price_bid" className="form-control" onChange={evt => this.updateInputValue(evt,"fee")} placeholder="enter price for sale" />

                                                <div className="spacer-20"></div>

                                                <div className="row">
                                                    <div className="col-md-6">
                                                        <h5>Expiration listing</h5>
...
export default ListingForSale(Listing);