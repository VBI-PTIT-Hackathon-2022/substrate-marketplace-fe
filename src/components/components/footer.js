                            ...
                            <div className="de-flex">
                                <div className="de-flex-col">
                                    <span onClick={()=> window.open("", "_self")}>
                                        <img alt="" className="f-logo d-1" src={process.env.PUBLIC_URL + "/assets/logo.png"} />
                                        <img alt="" className="f-logo d-3" src={process.env.PUBLIC_URL + "/assets/logo.png"} />
                                        <img alt="" className="f-logo d-4" src={process.env.PUBLIC_URL + "/assets/logo.png"} />
                                        <span className="copy">&copy; Copyright 2022 - NFT.owl</span>
                                    </span>
                                </div>
                                <div className="de-flex-col">
